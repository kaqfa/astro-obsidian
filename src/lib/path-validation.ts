...
export function validateSlug(slug: string): string {
  ...
  // Allowed: letters, numbers, spaces, hyphens, underscores, slashes, dots, parentheses, plus, apostrophe
  // Common punctuation: & (ampersand), , (comma), : (colon), ; (semicolon), + (plus), ' (apostrophe), ( and )
  // Examples: "Timeline & Milestones", "Note: Draft", "00 Ideas Inbox/Dev - Kids Space", "Technical Challenge (Backend)", "Feature + Update", "It's not super Apps"
